...
export default function Hero() {
  ...
  const bannerRef = useParallax<HTMLImageElement>(40);
  ...
  useEffect(() => {
    ...
    import("animejs").then(({ default: anime }) => {
      ...
      // Delaying start to ensure all elements are rendered
      requestAnimationFrame(() => {
        // Set initial states
        anime.set(".hero-char", { translateY: "120%", opacity: 0, rotateZ: 10, skewX: 10 });
        anime.set(".hero-engineer-box", { scaleX: 0, transformOrigin: "left center" });
        anime.set(".hero-engineer-text .hero-char", { translateY: "120%", opacity: 0, scale: 0.8 });
        anime.set([".hero-bio", ".hero-socials"], { opacity: 0, translateY: 30, scale: 0.95 });
        anime.set(".hero-banner", { opacity: 0, scale: 0.85, translateX: 60, rotateY: 20 });
      ...
      console.error("AnimeJS load failed in Hero:", err);
      // Fallback
      document.querySelectorAll(".hero-char, .hero-bio, .hero-socials, .hero-banner").forEach((el: any) => {
        el.style.opacity = "1";
    ...
    <section ref={sectionRef} className="pt-20 pb-0 min-h-screen flex items-center">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 w-full max-w-7xl">
        ...
        <div className="relative flex flex-col lg:flex-row items-center gap-10 py-12 lg:py-0 lg:min-h-[85vh] lg:gap-0">
            ...
            <div className="hero-socials flex items-center gap-3 justify-center lg:justify-start">
              <Magnetic strength={20}>
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-10 h-10 border border-gray-200 flex items-center justify-center hover:border-black hover:bg-black hover:text-white transition-all text-gray-700 rounded-full"
                >
          ...
          {/* Banner illustration with Parallax Effect */}
          <div className="hero-banner w-full lg:w-auto flex justify-center lg:flex-none" style={{ perspective: "1000px" }}>
            {/* <img
              ref={bannerRef}
              className="h-[42vh] sm:h-[55vh] lg:h-[80vh] w-auto max-w-[88vw] lg:max-w-[46vw] object-contain transition-transform duration-75"
              src="/svgs/banner.svg"
              alt="Hero Illustration"
            /> */}
            <div className="max-w-[40vw] overflow-hidden w-auto transition-transform duration-75">
              <LottiePlayer
                src="/lottie/code animation.lottie"
                autoplay
                loop
                className="h-[60vh]"
              />
